        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <asp:Calendar ID="Calendario" runat="server" ShowGridLines="true" Width="100%" SelectionMode="Day" OnDayRender="Calendario_DayRender" TitleStyle-BackColor="#042644" 
                    ...
                    OtherMonthDayStyle-BackColor="LightGray" OnSelectionChanged="Calendario_SelectionChanged" SelectedDayStyle-BackColor="#042644" OnVisibleMonthChanged="Calendario_VisibleMonthChanged">
...
<script type="text/javascript">
    ...
    function MuestraNuevoEvento() {//Para mostrar el modal desde code behind
